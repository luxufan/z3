...
if (Z3_LINK_TIME_OPTIMIZATION)
  ...
  if ((CMAKE_CXX_COMPILER_ID MATCHES "Clang") OR
      ...
      set(_lto_compiler_flag "-flto -fwhole-program-vtables")
      set(_lto_linker_flag "-flto -fuse-ld=lld")
  ...
  foreach (_config ${build_types_with_lto})
    ...
    set(CMAKE_EXE_LINKER_FLAGS_${_config} "${CMAKE_EXE_LINKER_FLAGS_${_config}} -Wl,-plugin-opt=stats-file=./stat-exe.json ${_lto_linker_flag}")
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${_lto_linker_flag}")
